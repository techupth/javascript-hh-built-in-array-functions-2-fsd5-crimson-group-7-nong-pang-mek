...
for (let i = 0; i < bills.length; i++) {
  if (!totalPaidByLocation[bills[i].location]) {
    totalPaidByLocation[bills[i].location] = bills[i].total;
  } else {
    totalPaidByLocation[bills[i].location] = totalPaidByLocation[bills[i].location] + bills[i].total;
  }
}
